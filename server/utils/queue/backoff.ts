 ...
 *   The FCM adapter surfaces this from the HTTP Retry-After header (firebase-admin@14
 *   plain-object headers fix, F4); pass undefined for providers that do not send one.
 */
